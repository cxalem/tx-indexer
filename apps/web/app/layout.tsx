...
export const metadata: Metadata = {
  ...
  description: "A TypeScript SDK that transforms raw Solana transactions into human-readable financial data. Automatically classifies swaps, transfers, and payments with protocol detection and confidence scoring.",
  keywords: ["solana", "blockchain", "transaction", "classifier", "sdk", "typescript", "defi", "web3"],
  authors: [{ name: "cxalem", url: "https://github.com/cxalem" }],
  openGraph: {
    title: "itx - Solana Transaction Classifier SDK",
    description: "Transform raw Solana transactions into human-readable financial data with automatic classification and protocol detection.",
