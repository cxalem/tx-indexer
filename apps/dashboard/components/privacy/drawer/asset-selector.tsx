  ...
  return (
    <div>
      ...
      <div className="relative">
        ...
        {isOpen && (
          <div className="absolute top-full left-0 right-0 mt-1 py-1 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg shadow-lg z-10">
